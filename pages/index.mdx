...
If you haven't already, make sure to first create your Slotsgateway Account through the [register form](https://backoffice.slotsgateway.com/register).
...
Grab the region URL, it is where you will send request to us.
